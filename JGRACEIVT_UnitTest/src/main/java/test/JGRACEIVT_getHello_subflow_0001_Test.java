...
public class JGRACEIVT_getHello_subflow_0001_Test {

	/*
	 * JGRACEIVT_getHello_subflow_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.7.0 on Mar 22, 2023 2:09:32 PM
	 */
	...
	/**
	 * Test for the getHello operation, expecting to get a CP4I0077 as a response
	 * @throws TestException
	 */
	@Test
	public void JGRACEIVT_getHello_subflow_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("JGRACEIVT")
				.messageFlow("gen.JGRACEIVT").node("getHello (Implementation)");
		...
		inputMessageAssembly.localEnvironmentPath("REST.Input.Operation").setValue("getHello");
		inputMessageAssembly.localEnvironmentPath("REST.Input.Path").setValue("/jgraceivt/v1/hello");
		inputMessageAssembly.localEnvironmentPath("REST.Input.URI").setValue("http://localhost/jgraceivt/v1/hello");
